...
<nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
    <div class="container">
        <div class="navbar-translate">
            <a class="navbar-brand" href="./index" rel="tooltip" data-placement="bottom">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="./fale_conosco.jsp" class="nav-link">
                		...
                		out.print("" +
                				"<li class='nav-item dropdown'>"+
	                                ...
	                                "<div class=\"dropdown-menu\" aria-labelledby=\"btnLogin\">"+
	                                  ...
	                                  "<a class=\"dropdown-item\" href=\"./cadastro_cliente.jsp\">Cadastrar</a>"+
	                                "</div>"+
	                              "</li>"+
                				"");
                	} else {
               			if(user.getRole().equals(Role.ADMIN)){
               				...
               				out.print("</a>"+
   	                                "<div class=\"dropdown-menu\" aria-labelledby=\"btnLogin\">"+
   	                                  ...
   	                                  "<a class=\"dropdown-item\" href=\"./cadastro_cliente.jsp\">Sair</a>"+
   	                                "</div>"+
   	                              "</li>"+
                   				"");
               			} else {
               				...
               				out.print("</a>"+
   	                                "<div class=\"dropdown-menu\" aria-labelledby=\"btnLogin\">"+
   	                                  ...
   	                                  "<a class=\"dropdown-item\" href=\"/CoisasAleatorias/usuarios?id=" + client.getUser().getId() + "\">Sair</a>"+
   	                                "</div>"+
   	                              "</li>"+
                   				"");
               			}
