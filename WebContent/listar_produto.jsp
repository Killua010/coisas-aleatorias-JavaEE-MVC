									...
									<table class="table">
										...
										<%
											List<Product> products =
												(List<Product>) request.getAttribute("produtos");
											...
											for(Product product: products) {
												...
												out.print("<td class='text-center'><a href='produtos?id=" + product.getId() + "' class='btn btn-warning'>Editar</a></td>");
												out.print("<td class='text-center'><form action='/CoisasAleatorias/produtos' method='POST'><input type='hidden' name='txtId' value='" + product.getId() + "' /> <button class='btn btn-danger' type='submit' name='operacao' value='DELETAR'>Excluir</button></form></td>");
												out.print("</tr>");
											}
